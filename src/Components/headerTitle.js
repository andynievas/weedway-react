...
// ndeaaaAa
    return (
      <div>
        <div className="animate__animated animate__fadeInDown" style={{ backgroundColor: 'rgb(30,30,30)', borderTop: '2px rgb(30,30,30) solid', borderBottom: '2px rgb(30,30,30) solid', display: 'flex', width: '100%'} } >
